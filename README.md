...
-	clone project
o	clone git : git clone https://github.com/MujtabaMohsin/Foodbox
...
o	cd to your project “Back-end\foodbox”
o	mvn compile
o	mvn exec:java -Dexec.mainClass=com.simplilearn.foodbox
